...
function Navbar() {
  ...
  return (
    <nav>
      ...
      <div
        className={`fixed top-0 right-0 h-screen w-64 bg-surface z-50 p-6 flex flex-col gap-6 md:hidden transition-transform duration-300 ${menuAbierto ? "translate-x-0" : "translate-x-full"}`}
      >
        <Link
          to="/"
          onClick={() => setMenuAbierto(false)}
